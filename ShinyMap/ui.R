  ...
  sidebarLayout(
    ...
    mainPanel(
      bsPopover(id = "plot1",
                ...
                content = "The time series graph above visualizes species occurrence records for the area selected on the map. Normalization options in the panel to the left are provided to correct for biases when comparing records across years.",
                placement = "bottom",
                trigger = "hover"),
      plotOutput("plot1")
    )
